...
const MyYieldsPage: React.FC = () => {
  ...
  const summaryTotals = useMemo(() => {
    ...
    const connected =
      wallet?.isConnected && wallet.address ? wallet.address : null;
        ...
        <div className={styles.summaryCards}>
          ...
          <div className={styles.summaryCard}>
            <div className={styles.summaryTitle}>
              Current Deposit
              <InfoIcon
                tooltipText="Amount currently invested. (Total Deposit – Withdrawn Deposit)"
                tooltipTitle="Current Deposit"
              />
            </div>
            ...
            <div className={styles.summarySubtext}>
              ...
              <InfoIcon
                tooltipText="Total amount ever deposited (including withdrawn + currently invested funds)."
                tooltipTitle="Total Deposit"
              />
            </div>
          </div>
          ...
          <div className={styles.summaryCard}>
            <div className={styles.summaryTitle}>
              Current Earned
              <InfoIcon
                tooltipText="Excludes any profit already withdrawn."
                tooltipTitle="Current Earnings"
              />
            </div>
            <div
            ...
            >
              ...
              <InfoIcon
                tooltipText="Your total profit since day 1, including withdrawn and reinvested gains."
                tooltipTitle="Total Earning"
              />
            </div>
          </div>
          ...
          <div className={styles.summaryCard}>
            <div className={styles.summaryTitle}>
              Daily Yield
              <InfoIcon
                tooltipText="Estimated daily return."
                tooltipTitle="Daily Yield"
              />
            </div>
            <div
              className={styles.summaryAmount}
            ...
            >
              ...
              <InfoIcon
                tooltipText="Estimated annual return based on current performance."
                tooltipTitle="Yearly Yield"
              />
            </div>
          </div>
        </div>
